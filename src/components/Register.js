      ...
      {error && <Alert variant="danger">{error}</Alert>}
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group id="password-confirm" className="mb-2">
              ...
              <Form.Control type="password"placeholder="re-enter the password" ref={passwordConfirmRef} required />
            </Form.Group>
            <Button  disabled={loading} className="w-100 mt-4" type="submit">
              Sign Up
            </Button>
          </Form>
          <Card.Text className="mt-2 text-center px-5"><small>By signing up, you agree to our Terms , Data Policy and Cookies Policy .</  small></Card.Text>
        </Card.Body>
      </Card>
